...
func (cp *CreateProduct) Execute(name string, price float32, descripcion string, stock int32) (*entities.Product, error) {
    product := entities.NewProduct(name, price, stock, descripcion)
